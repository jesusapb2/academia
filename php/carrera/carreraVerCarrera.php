            ...
            <div id="formulario">
                <?php
                    ...
                    if($resultado){
                        ...
                        $direccion =  "../carrera/carreraBorrarConfirmado.php?carrera=$dato";

                        echo "<a href='" . $direccion . "'>Borrar</a>";
                        echo "<a href='../../webs/carrera/menuCarreras.html?mensaje=202'>Salir sin borrar</a>"; 
                    }else{
